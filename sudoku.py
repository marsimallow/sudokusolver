def find_next_empty(puzzle):
    # this finds the next row, col on the puzzle that's not filled yet --> rep with -1
...
def is_valid(puzzle, guess, row, col):
    ...
    # and then the square :3c
    # this gon be quite tricky, but we want to get where the 3x3 square starts.
...
def solve_sudoku(puzzle):
    ...
    for guess in range(1, 10): # range (1, 10) is 1, 2, 3, ...9
        ...
        if is_valid(puzzle, guess, row, col):
            ...
            # now recurse using this puzzle!! >:3
        ...
        puzzle[row][col] = -1 # reset the guess n.n
